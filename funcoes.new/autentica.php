...
{	
	...
	$_SESSION['url_ged_server_local'] = "http://localhost/sigapce/ged/";
	$_SESSION['url_ged_server_hom'] = "http://sigapce.2rm.eb.mil.br/ged/";
	$_SESSION['url_ged_server_prd'] = "http://sigapce.2rm.eb.mil.br/ged/";

	$_SESSION['url_sae_foto_local'] = "http://localhost/sigapce/sae/";
	$_SESSION['url_sae_foto_hom'] = "http://sigapce.2rm.eb.mil.br/sae/";
	$_SESSION['url_sae_foto_prd'] = "http://sigapce.2rm.eb.mil.br/sae/";
