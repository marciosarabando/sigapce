		...
		<div class="col-md-12 column">
			<nav class="navbar navbar-default" role="navigation">
				<div class="navbar-header">
					 <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1"> <span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button> <a class="navbar-brand" href="sae.php"><img width="25" height="22" src="img/simbolo_2rm.png" class="img-polaroid"> SIGAPCE / SAE</a>
				</div>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<?php
							...
							{ 
								...
								<li class='dropdown'>
									...
									<li>
									<a href='?url=controle_acesso'><i class='glyphicon glyphicon-user'></i> USUÁRIOS REQUERENTES</a>
									</li>
					...
					<?php
							...
							{ 
								echo("
								<li class='dropdown'>
									<a href='#' class='dropdown-toggle' data-toggle='dropdown'>AGENDA<strong class='caret'></strong></a>
									<ul class='dropdown-menu'>
									<li>
									<a href='?url=gerenciar_agenda'><i class='glyphicon glyphicon-calendar'></i> GERENCIAR AGENDA</a>
									</li>
									</ul>
								</li>
								");
						...
						<li class='dropdown'>
							<a href='#' class='dropdown-toggle' data-toggle='dropdown'>ATENDIMENTO<strong class='caret'></strong></a>
							<ul class='dropdown-menu'>
								<li>
									<a href='?url=atender_usuarios_agendados'><i class='glyphicon glyphicon-calendar'></i> REALIZAR ATENDIMENTO</a>
								</li>
							</ul>
						</li>
	...
	<div class="row clearfix">
		<div class="col-md-12 column">
			<?php		
				...
				{
					$url = $_GET['url'];	
					if ($url == 'controle_acesso')
					{
						include ("sae/frm_controle_acesso.php");	
					}
					if ($url == 'gerenciar_agenda')
					{
						include ("sae/frm_gerencia_agenda.php");
					}
					if ($url == 'atender_usuarios_agendados')
					{
						include ("sae/frm_atendimento_agenda.php");
					}
					if ($url == 'tutorial')
					{
						include ("sae/frm_tutorial_sae.php");
					}
