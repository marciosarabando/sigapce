							...
							<ul class="dropdown-menu">
								<?php
									...
									if (in_array($modulo_ged, $id_modulo_login_permissao))
									{
										echo("
												<li>
													<a href='ged.php'><i class='glyphicon glyphicon-tasks'></i> GED - GESTÃO ELETRÔNICA DE DOCUMENTOS</a>
												</li>
											");
									}
                                    ...
                                    echo("
												<li>
													<a href='http://intranet.2rm.eb.mil.br/apoio/index.php' target='_blank'><i class='glyphicon glyphicon-inbox'></i> SISTEMA DE APOIO</a>
												</li>
											");
                                    ...
                                    if (in_array($modulo_ged, $id_modulo_login_permissao))
									{
										echo("
												<li>
													<a href='adt.php'><i class='glyphicon glyphicon-list-alt'></i> ADT - ADITAMENTO AO BAR</a>
												</li>
											");
									}
								?>
