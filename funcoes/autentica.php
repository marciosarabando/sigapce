...
{	
	...
	//DEFINE AS SESSIONS DE AMBIENTE
	$_SESSION['ambiente'] = "PROD"; //VALORES POSSÍVEIS: DESENV - HOM - PROD

	
	$_SESSION['url_ged_server_local'] = "img/foto_usuario";
	$_SESSION['url_ged_server_hom'] = "http://agendamentosfpc.2rm.eb.mil.br/img/";
	$_SESSION['url_ged_server_prd'] = "http://agendamentosfpc.2rm.eb.mil.br/img/";

	$_SESSION['url_sae_foto_local'] = "img/foto_usuario";
	$_SESSION['url_sae_foto_hom'] = "http://agendamentosfpc.2rm.eb.mil.br/img/";
	$_SESSION['url_sae_foto_prd'] = "http://agendamentosfpc.2rm.eb.mil.br/img/";
