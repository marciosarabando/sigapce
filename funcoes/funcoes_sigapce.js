...
function entrar()
{
	...
	var senha_login = document.getElementById('txt_senha_sfpc').value;
	...
	{
		document.getElementById('txt_senha_sfpc').focus();
	}
	else
	{
		document.getElementById('senha_sfpc').value = md5(senha_login);
