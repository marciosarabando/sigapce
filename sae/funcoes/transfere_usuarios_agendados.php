			   ...
			   if($periodo == 'dia')
			   {
				...
				if($periodo == 'dia')
				{
					$query = "INSERT INTO agendamento_requerente SELECT
							...
							INNER JOIN agendamento_data on agendamento_data.id_agendamento_data = agendamento_horario.id_agendamento_data AND agendamento_data.unidade_id_unidade = $id_unidade
