...
<div id="wrap">
  ...
  <div class="container">
      ...
      <form id='formLogin_siagpc' name="formLogin_siagpc" class="form-signin" method="post" action="funcoes/autentica.php">
        ...
        <input type="password" id='senha_sfpc' name="senha_sfpc" maxlength="20" class="input-block-level" placeholder="Senha">
      ...
      <center><font color="blue">Versão 2.0 - Agosto de 2016</font></center>
      <br>
...
<div id="footer">
      <div class="container">
        <center><p class="muted credit">Desenvolvido por 2º Ten OTT Sarabando - SFPC do Comando da 2ª Região Militar - © Copyright 2016</p><br></center>
      </div>
 </div>
