		...
		<div class="col-md-12 column">
			<nav class="navbar navbar-default" role="navigation">
				<div class="navbar-header">
					 <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1"> <span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button> <a class="navbar-brand" href="adt.php"><img width="25" height="22" src="img/simbolo_2rm.png" class="img-polaroid"> SIGAPCE / ADT</a>
				</div>
				
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">GERENCIAR<strong class="caret"></strong></a>
							<ul class="dropdown-menu">
								<li>
									<a href="?url=materia"><i class="glyphicon glyphicon-pencil"></i> MATÉRIAS</a>
								</li>
								<li>
									<a href="?url=aditamento"><i class="glyphicon glyphicon-list-alt"></i> ADITAMENTOS</a>
								</li>
	...
	<div class="row clearfix"> 
			...
			<?php		
				...
				if (isset($_GET['url']) != null)
				{
					...
					if ($url == 'materia')
					{
						include ("adt/frm_revisao_materias_adt.php");	
					}
					if ($url == 'aditamento')
					{
						include ("adt/frm_gestao_aditamento.php");	
					}

					if ($url == 'novo')
					{
						include ("adt/novo_aditamento.php");	
					}

					if ($url == 'tipos_materia')
					{
						include ("adt/tipos_materia.php");	
					}

					if ($url == 'exibe_tipo_materia')
					{
						$id_tipo_materia = $_GET['tipo_materia']; 

						include ("adt/exibe_tipo_materia.php");	
					}

					if ($url == 'editar_tipo_materia')
					{
						$id_tipo_materia = $_GET['tipo_materia']; 

						include ("adt/novo_tipo_materia.php");	
					}

					if ($url == 'excluir_tipo_materia')
					{
						$id_tipo_materia = $_GET['tipo_materia']; 

						include ("adt/excluir_tipo_materia.php");	
					}
					...
					if ($url == 'exibe_adt')
					{
						...
						include ("adt/exibe_adt.php");	
					}
				}	
				else
				{
					include("noticia_adt.php");					
				}
			?>
		</div>
	</div>
