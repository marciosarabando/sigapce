...
<div class="well">
	<table>
		<tr>
			<td>
				<a href="sae.php" class="img"><img src="img/sae.jpg" width='100' alt="SAE/2"></a>
			</td>
			<td>
				<p><h3>MÓDULO SAE <small> SISTEMA DE AGENDAMENTO ELETRÔNICO DA SFPC/2</small></h3></p>
