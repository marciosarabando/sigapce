		...
		<div class="col-md-12 column">
			<nav class="navbar navbar-default" role="navigation">
				<div class="navbar-header">
					 <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1"> <span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button> <a class="navbar-brand" href="ged.php"><img width="25" height="22" src="img/simbolo_2rm.png" class="img-polaroid"> SIGAPCE / GED</a>
				</div>
				
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">DOCUMENTO<strong class="caret"></strong></a>
							<ul class="dropdown-menu">
								<li>
									<a href="?url=pesquisa_documento"><i class="glyphicon glyphicon-search"></i> BUSCAR</a>
								</li>
								<li>
									<a href="?url=upload_documento"><i class="glyphicon glyphicon-import"></i> IMPORTAR</a>
								</li>
